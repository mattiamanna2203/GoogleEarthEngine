...
var green_area_before_storm = compute_NDVI(S2,Areacolpita,"2018-06-01","2018-07-30",ndvi_t);


print("");

// Apply the compute_NDVI function and get the km^2 oh healty vegetation after the storm
var green_area_after_storm = compute_NDVI(S2,Areacolpita,"2019-06-01","2019-07-30",ndvi_t);
